    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('associated_beer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.Beer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wifi_host_ip', models.CharField(default='', help_text='Cached IP address in case of mDNS issues (only used if connection_type is wifi)', max_length=46)),
